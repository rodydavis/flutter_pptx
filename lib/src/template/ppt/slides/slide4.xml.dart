...
/// Path: ./template/ppt/slides/slide4.xml
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
    ...
    <p:cSld>
        <p:spTree>
            ...
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="172" name="SLIDE TITLE"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
                        <p:ph type="title"/>
                    </p:nvPr>
            ...
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="173" name="SLIDE BULLET A…"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
                ...
                <p:txBody>
                    ...
                    <a:p>
                        <a:pPr/>
                        <a:r>
                            <a:t>SLIDE BULLET A</a:t>
                        </a:r>
                    </a:p>
                    <a:p>
                        <a:pPr/>
                        <a:r>
                            <a:t>SLIDE BULLET B</a:t>
                        </a:r>
                    </a:p>
                    <a:p>
                        <a:pPr/>
                        <a:r>
                            <a:t>SLIDE BULLET C</a:t>
                        </a:r>
                    </a:p>
                </p:txBody>
            </p:sp>
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="174" name="Slide Subtitle"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
