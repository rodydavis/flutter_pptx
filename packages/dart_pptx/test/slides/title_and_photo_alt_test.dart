...
void main() {
  group('Title and photo alt slide tests', () {
    var pres = PowerPoint();
    ...
    test('Check if added', () async {
      ...
      expect(slide.runtimeType, SlideTitleAndPhotoAlt);
    });
    ...
    test('ppt/slides/slide1.xml', () async {
      ...
      final slide = pres.slides[0] as SlideTitleAndPhotoAlt;
    ...
    test('ppt/slides/_rels/slide1.xml.rels', () {
      ...
      expect(content, contains('slideLayout3.xml"'));
    });
