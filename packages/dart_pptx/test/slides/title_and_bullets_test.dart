...
void main() {
  group('Title and bullets slide tests', () {
    var pres = PowerPoint();
    ...
    test('Check if added', () async {
      ...
      expect(slide.runtimeType, SlideTitleAndBullets);
    });
    ...
    test('ppt/slides/slide1.xml', () async {
      ...
      final slide = pres.slides[0] as SlideTitleAndBullets;
      slide.title = TextValue.uniform(title);
      slide.subtitle = TextValue.uniform(subtitle);
      slide.bullets = [TextValue.uniform(bullets)];
    ...
    test('ppt/slides/_rels/slide1.xml.rels', () {
      ...
      expect(content, contains('slideLayout4.xml"'));
    });
