...
void main() {
  group('Title, bullets photo slide tests', () {
    var pres = PowerPoint();
    ...
    test('ppt/slides/slide1.xml', () async {
      ...
      expect(content.indexOf(bullets), -1);
      expect(files['ppt/media/image1.png'], isNotNull);

      final slide = pres.slides[0] as SlideTitleBulletsAndPhoto;
      ...
      slide.bullets = [bullets.toTextValue()];
      ...
      expect(content.indexOf(bullets), isNot(-1));
      expect(files['ppt/media/image1.png'], isNotNull);
    });
    ...
    test('ppt/slides/_rels/slide1.xml.rels', () {
      ...
      expect(content, contains('slideLayout6.xml"'));
    });
