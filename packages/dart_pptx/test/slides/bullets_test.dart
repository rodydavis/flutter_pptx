...
void main() {
  group('Bullets slide tests', () {
    ...
    test('ppt/slides/_rels/slide1.xml.rels', () {
      ...
      expect(content, contains('slideLayout5.xml"'));
    });
